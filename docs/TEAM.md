...
|---:|---|---|---|---|---|
| 1 | Nguyễn Thế Khang | 2A202602964 | | Pipeline Lead & Integrator — Toàn bộ modules (`core/`, `ingestion/`, `retrieval/`, `evaluation/`, `observability/`, `pipelines/`) | `report/individual_report.md` |
