...
def _extract_answer(question: str, top_result: SearchResult) -> str:
    ...
    if "who authored" in lowered or "list the authors" in lowered or "authors" in lowered:
    ...
    if "what categories" in lowered or "categories" in lowered or "subject" in lowered:
